...
<template>
    <div class="relative">
      ...
      <button @click="open = !open" class="relative flex items-center focus:outline-none">
        ...
        <img  src="@/assets/img/ethereum-logo-wireframe.png" alt="ETH avatar" class="rounded-full h-8 w-5">

        <span class="ml-2 font-medium truncate text-green-400" style="max-width:80px">{{acctAddress}}</span>
